...
class _HomeScreenState extends State<HomeScreen> {
  int _index = 0;
  final _pages = const [ChatsScreen(), ContactsScreen(), StoriesScreen(), MeScreen()];
    ...
    return Scaffold(
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: const [
          ...
          NavigationDestination(icon: Icon(Icons.auto_stories_outlined), selectedIcon: Icon(Icons.auto_stories), label: '剧情'),
